...
interface ChartDao {
     ...
     * By chart id
     */
    @Query("UPDATE charts SET is_installed = :isInstalled AND available_version = :availableVersion WHERE id = :id")
    fun update(id: String, isInstalled: Boolean?, availableVersion: Int?)
